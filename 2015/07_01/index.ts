...
do {
  results = runInstructions(instructions, results?.wireSignals);
  instructions = results.unfulfilledInstructions;
} while (results.unfulfilledInstructions.length > 0);

console.log(results.wireSignals['a'])